...
# Dataset
from datasets.Railway3D_only_xyz import *
...
if __name__ == '__main__':
    ...
    # Initialize datasets
    training_dataset = Railway3DDataset(config, set='training', use_potentials=True)
    test_dataset = Railway3DDataset(config, set='validation', use_potentials=True)

    # Initialize samplers
    training_sampler = Railway3DSampler(training_dataset)
