...
class Railway3DDataset(PointCloudDataset):
    ...
    def __init__(self, config, set='training', use_potentials=True, load_data=True):
        ...
        # Dataset folder
        self.path = 'repos/data/'
        self.kp_data_path = 'repos/data/urban_railways/kp_processed_data/'
        if not exists(self.kp_data_path):
            makedirs(self.kp_data_path)
        # Type of task conducted on this dataset
        self.dataset_task = 'cloud_segmentation'
        self.scene = 'urban_railways'
    ...
    def load_subsampled_clouds(self):
        ...
        for i, file_path in enumerate(self.files):
            ...
            if exists(KDTree_file):
                ...
                sub_colors = np.vstack((intensity, intensity, intensity)).T
...
class Railway3DSampler(Sampler):
    """Sampler for Railway3D"""

    def __init__(self, dataset: Railway3DDataset):
...
def Railway3DCollate(batch_data):
    return Railway3DCustomBatch(batch_data)
